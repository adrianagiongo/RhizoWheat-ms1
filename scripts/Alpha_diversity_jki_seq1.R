...
ggsave("violin_plot_psO_jki_seq1_layer5_filt_rarefied_evenness_rotation.png", path = "~/Documents/R_analysis/jki_seq1/output_jki_seq1/Alpha_div_jki_seq1/", width = 11, height = 12, units = "cm", dpi = 300, device = "png")
